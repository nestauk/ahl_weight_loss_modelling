...
funScenario <- function(id, w0, height, sex, age, w1, days, max_cal){
  
  CalRedShare <- seq(0.01,max_cal,by=0.01)  # List of potential calorie reduction values
  ...
  # tout <- (seq(0, times, by = times/40)) # calculate 1 month intervals (30 days approximately)
  
  tout <- (seq(0, times, by = times/40)) 
...
write_csv(morb_obese, "/Users/elenamariani/Documents/working/weight_loss_modelling/processed_data/hse_morb_obese_weight_loss_3_steps.csv")
...
write_csv(obese, "/Users/elenamariani/Documents/working/weight_loss_modelling/processed_data/hse_obese_weight_loss_3_steps.csv")
...
write_csv(over, "/Users/elenamariani/Documents/working/weight_loss_modelling/processed_data/hse_over_weight_loss_3_steps.csv")
...
write_csv(normal, "/Users/elenamariani/Documents/working/weight_loss_modelling/processed_data/hse_normal_weight_loss_3_steps.csv")


full <- rbind(normal, over, obese, morb_obese)

write_csv(full, "/Users/elenamariani/Documents/working/weight_loss_modelling/processed_data/hse_full_weight_loss_3_steps.csv")
